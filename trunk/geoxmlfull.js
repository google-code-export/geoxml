...
GeoXml.prototype.handlePlacemark = function (mark, idx, depth, fullstyle) {
     ...
     var poly_count=0;
    var coords = "";
    // if(kml_id)alert("id found handling placemark"+kml_id);
...
GeoXml.prototype.processing = function(xmlDoc,title, latlon, desc, sbid) {
   ...
   if(basename == "kml") {	
	...
	this.kml[0].folders.push(this.overlayman.folders.length);
		...
		if(this.basesidebar) { 	var folderid = this.createFolder(idx,title,this.basesidebar,this.globalicon,desc,null,keepopen,true); }
